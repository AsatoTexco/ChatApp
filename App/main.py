...
s.settimeout(0.1)  # Tempo limite de 100ms
...
def listen():
    ...
    while listen_cond == True:
        try:
            ...
            listen_socket.bind(('0.0.0.0', 2006))
